...
import { provideHass } from "../../../fake_data/provide_hass";
...
class MoreInfoLight extends LitElement {
  ...
  render(): TemplateResult {
    ...
    var switchWidth = "150px";
    var switchHeight = "380px";
    ...
    var sliderColor = "#FFF";
    var sliderColoredByLight = true;
    var sliderThumbColor = "#ddd";
    var sliderTrackColor = "#ddd";
    var switchColor = "#FFF";
    var switchTrackColor = "#ddd";
