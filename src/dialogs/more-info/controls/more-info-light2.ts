...
import { getLightCurrentModeRgbColor, LightColorModes, LightEntity, lightIsInColorMode, lightSupportsColor, lightSupportsColorMode, lightSupportsDimming, SUPPORT_EFFECT, } from "../../../data/light";
import type { HomeAssistant } from "../../../types";

@customElement("more-info-light2")
